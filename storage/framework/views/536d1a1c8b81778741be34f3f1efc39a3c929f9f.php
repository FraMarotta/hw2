...
<html>
    <head>
        ...
        <link rel="stylesheet" href="<?php echo e(asset('styles/home_style.css')); ?>" />
      ...
      <article id="modale" class="hidden"> 
        ...
        <header>
            ...
            <nav>
              ...
              <div id="links">
                <a href="">Home</a>
                <a href="<?php echo e(asset('login_signup')); ?>">SIGN-UP/LOGIN</a>
              </div>
...
</html><?php /**PATH C:\xampp\htdocs\WebProgramming\Homework\HW2\resources\views/home.blade.php ENDPATH**/ ?>